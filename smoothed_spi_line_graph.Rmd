...
538's Soccer Power Index rates the quality of soccer teams from a variety of leagues around the world. In this post I'll use `gganimate` to animate the quality of the teams across the past 3 seasons.
...
Load the data and make the data long:
```{r}
