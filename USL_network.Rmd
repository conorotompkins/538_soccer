...
##Network graph
In this snippet I set a threshhold for how similar clubs need to be to warrant a connection. Then I graph it using tidygraph and ggraph.
...
```
The group_edge_betweenness() function clusters the clubs into communities according to which clubs they are similar to. FC Cincinnati and New York Redbulls II are unique acording to this measure. Groups 1 and 2 are mostly good clubs in different ways. The clubs in Group 3 struggle. My club, the Pittsburgh Riverhounds, are most similar to the Charleston Battery and Nashville FC.
